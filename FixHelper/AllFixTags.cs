...
namespace FixHelper
{
    ...
    public class AllFixTags
    {
        ...
        private AllFixTags()
        {
            tags = new List<Tag>()
            {
                //new Tag(37,"OrderID","8","BIST DC","Y","String"),
                //new Tag(453,"NoPartyIDs","8","BIST DC","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","8","BIST DC","Q","String"),
                //    new Tag(447,"PartyIDSource","8","BIST DC","Q","char"),
                //    new Tag(452,"PartyRole","8","BIST DC","Q","int"),}),
                //new Tag(17,"ExecID","8","BIST DC","Y","String"),
                //new Tag(66,"ListID","8","BIST DC","N","String"),
                //new Tag(880,"TrdMatchID","8","BIST DC","N","String"),
                //new Tag(20034,"ComboMatchID","8","BIST DC","N","???"),
                //new Tag(150,"ExecType","8","BIST DC","Y","char"),
                //new Tag(39,"OrdStatus","8","BIST DC","Y","char"),
                //new Tag(1,"Account","8","BIST DC","N","String"),
                //new Tag(55,"Instrument/Symbol","8","BIST DC","Q","???"),
                //new Tag(48,"Instrument/SecurityID","8","BIST DC","Q","???"),
                //new Tag(22,"Instrument/SecurityIDSource","8","BIST DC","Q","???"),
                //new Tag(54,"Side","8","BIST DC","Y","char"),
                //new Tag(38,"OrderQtyData/OrderQty","8","BIST DC","Q","???"),
                //new Tag(40,"OrdType","8","BIST DC","Q","char"),
                //new Tag(44,"Price","8","BIST DC","N","Price"),
                //new Tag(21100,"LastUnderlyingPx","8","BIST DC","N","Price"),
                //new Tag(21101,"UnderlyingColPx","8","BIST DC","N","Price"),
                //new Tag(1100,"TriggeringInstruction/TriggerType","8","BIST DC","N","???"),
                //new Tag(1101,"TriggeringInstruction/TriggerAction","8","BIST DC","N","???"),
                //new Tag(1102,"TriggeringInstruction/TriggerPrice","8","BIST DC","N","???"),
                //new Tag(1113,"TriggeringInstruction/TriggerTradingSessionID","8","BIST DC","N","???"),
                //new Tag(1103,"TriggeringInstruction/TriggerSymbol","8","BIST DC","N","???"),
                //new Tag(1104,"TriggeringInstruction/TriggerSecurityID","8","BIST DC","N","???"),
                //new Tag(1105,"TriggeringInstruction/TriggerSecurityIDSource","8","BIST DC","N","???"),
                //new Tag(1107,"TriggeringInstruction/TriggerPriceType","8","BIST DC","N","???"),
                //new Tag(1109,"TriggeringInstruction/TriggerPriceDirection","8","BIST DC","N","???"),
                //new Tag(59,"TimeInForce","8","BIST DC","Q","char"),
                //new Tag(336,"TradingSessionID","8","BIST DC","N","String"),
                //new Tag(432,"ExpireDate","8","BIST DC","N","LocalMktDate"),
                //new Tag(18,"ExecInst","8","BIST DC","N","MultipleValueString"),
                //new Tag(528,"OrderCapacity","8","BIST DC","N","char"),
                //new Tag(151,"LeavesQty","8","BIST DC","Y","Qty"),
                //new Tag(14,"CumQty","8","BIST DC","Y","Qty"),
                //new Tag(6,"AvgPx","8","BIST DC","Y","Price"),
                //new Tag(60,"TransactTime","8","BIST DC","Q","UTCTimestamp"),
                //new Tag(378,"ExecRestatementReason","8","BIST DC","N","int"),
                //new Tag(442,"MultiLegReportingType","8","BIST DC","N","char"),
                //new Tag(555,"NoLegs","8","BIST DC","N","NumInGroup",new List<Tag>(){
                //    new Tag(600,"LegSymbol","8","BIST DC","Q","String"),
                //    new Tag(602,"LegSecurityID","8","BIST DC","Q","String"),
                //    new Tag(603,"LegSecurityIDSource","8","BIST DC","Q","String"),
                //    new Tag(637,"LegLastPx","8","BIST DC","Q","Price"),
                //    new Tag(1418,"LegLastQty","8","BIST DC","Q","Qty"),
                //    new Tag(20200,"LegTrdMatchID","8","BIST DC","Q","String"),}),
                //new Tag(70,"AllocID","8","BIST DC","N","String"),
                //new Tag(797,"CopyMsgIndicator","8","BIST DC","Q","Boolean"),
                //new Tag(1089,"MatchIncrement","8","BIST DC","N","Qty"),
                //new Tag(111,"MaxFloor","8","BIST DC","N","Qty"),
                //new Tag(119,"SettlCurrAmt","8","BIST DC","N","Amt"),
                //new Tag(20015,"OptPremiumAmt","8","BIST DC","N","???"),
                //new Tag(20009,"OrderReference","8","BIST DC","N","String"),
                //new Tag(20199,"OpenCloseIndicator","8","BIST DC","N","int"),
                //new Tag(117,"QuoteID","AI","BIST DC","Q","String"),
                //new Tag(537,"QuoteType","AI","BIST DC","Q","int"),
                //new Tag(298,"QuoteCancelType","AI","BIST DC","N","int"),
                //new Tag(453,"NoPartyIDs","AI","BIST DC","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","AI","BIST DC","Q","String"),
                //    new Tag(447,"PartyIDSource","AI","BIST DC","Q","char"),
                //    new Tag(452,"PartyRole","AI","BIST DC","Q","int"),}),
                //new Tag(55,"Symbol","AI","BIST DC","Q","String"),
                //new Tag(48,"SecurityID","AI","BIST DC","Q","String"),
                //new Tag(22,"SecurityIDSource","AI","BIST DC","Q","String"),
                //new Tag(132,"BidPx","AI","BIST DC","N","Price"),
                //new Tag(133,"OfferPx","AI","BIST DC","N","Price"),
                //new Tag(134,"BidSize","AI","BIST DC","N","Qty"),
                //new Tag(135,"OfferSize","AI","BIST DC","N","Qty"),
                //new Tag(297,"QuoteStatus","AI","BIST DC","N","int"),
                //new Tag(1,"Account","AI","BIST DC","N","String"),
                //new Tag(528,"OrderCapacity","AI","BIST DC","N","char"),
                //new Tag(797,"CopyMsgIndicator","AI","BIST DC","Q","Boolean"),
                //new Tag(571,"TradeReportID","AE","BIST DC","Y","String"),
                //new Tag(1003,"TradeID","AE","BIST DC","N","String"),
                //new Tag(1126,"OrigTradeID","AE","BIST DC","N","String"),
                //new Tag(572,"TradeReportRefID","AE","BIST DC","N","String"),
                //new Tag(818,"SecondaryTradeReportID","AE","BIST DC","N","String"),
                //new Tag(487,"TradeReportTransType","AE","BIST DC","Q","int"),
                //new Tag(856,"TradeReportType","AE","BIST DC","Q","int"),
                //new Tag(828,"TrdType","AE","BIST DC","N","int"),
                //new Tag(829,"TrdSubType","AE","BIST DC","Q","int"),
                //new Tag(573,"MatchStatus","AE","BIST DC","Q","char"),
                //new Tag(880,"TrdMatchID","AE","BIST DC","Q","String"),
                //new Tag(20034,"ComboMatchID","AE","BIST DC","N","???"),
                //new Tag(570,"PreviouslyReported","AE","BIST DC","Y","Boolean"),
                //new Tag(55,"Symbol","AE","BIST DC","Q","String"),
                //new Tag(48,"SecurityID","AE","BIST DC","Q","String"),
                //new Tag(22,"SecurityIDSource","AE","BIST DC","Q","String"),
                //new Tag(32,"LastQty","AE","BIST DC","Y","Qty"),
                //new Tag(31,"LastPx","AE","BIST DC","Y","Price"),
                //new Tag(20017,"WithHoldingTax","AE","BIST DC","N","Price"),
                //new Tag(20018,"RepoInterestAmt","AE","BIST DC","N","Price"),
                //new Tag(730,"SettlementPrice","AE","BIST DC","N","???"),
                //new Tag(1703,"NoCollateralAmounts","AE","BIST DC","N","NumInGroup",new List<Tag>(){
                //    new Tag(1704,"CurrentCollateralAmount","AE","BIST DC","N","long"),}),
                //new Tag(21100,"LastUnderlyingPx","AE","BIST DC","N","Price"),
                //new Tag(21101,"UnderlyingColPx","AE","BIST DC","N","Price"),
                //new Tag(119,"SettlCurrAmt","AE","BIST DC","N","Amt"),
                //new Tag(75,"TradeDate","AE","BIST DC","Y","LocalMktDate"),
                //new Tag(60,"TransactTime","AE","BIST DC","Y","UTCTimestamp"),
                //new Tag(64,"SettlDate","AE","BIST DC","N","LocalMktDate"),
                //new Tag(552,"NoSides","AE","BIST DC","Y","NumInGroup",new List<Tag>(){
                //    new Tag(54,"Side","AE","BIST DC","Y","char"),
                //    new Tag(37,"OrderID","AE","BIST DC","Y","String"),
                //    new Tag(453,"NoPartyIDs","AE","BIST DC","Q","NumInGroup",new List<Tag>(){
                //        new Tag(448,"PartyID","AE","BIST DC","Q","String"),
                //        new Tag(447,"PartyIDSource","AE","BIST DC","Q","char"),
                //        new Tag(452,"PartyRole","AE","BIST DC","Q","int"),}),
                //    new Tag(528,"OrderCapacity","AE","BIST DC","N","char"),
                //    new Tag(483,"TransBkdTime","AE","BIST DC","N","UTCTimestamp"),
                //    new Tag(20006,"CleanPrice","AE","BIST DC","N","Price"),
                //    new Tag(20009,"OrderReference","AE","BIST DC","N","String"),
                //    new Tag(1,"Account","AE","BIST DC","N","String"),
                //    new Tag(70,"AllocID","AE","BIST DC","N","String"),
                //    new Tag(151,"LeavesQty","AE","BIST DC","N","Qty"),
                //    new Tag(1057,"AggressorIndicator","AE","BIST DC","N","Boolean"),}),
                //new Tag(715,"ClearingBusinessDate","AE","BIST DC","N","LocalMktDate"),
                //new Tag(855,"SecondaryTrdType","AE","BIST DC","N","int"),
                //new Tag(20007,"CorrespondingPrice","AE","BIST DC","N","Price"),
                //new Tag(20008,"Consideration","AE","BIST DC","N","Price"),
                //new Tag(20013,"DeferredPublicationTime","AE","BIST DC","N","int"),
                //new Tag(20015,"OptPremiumAmt","AE","BIST DC","N","???"),
                //new Tag(381,"GrossTradeAmt","AE","BIST DC","N","Amt"),
                //new Tag(20199,"OpenCloseIndicator","AE","BIST DC","N","int"),
                //new Tag(21102,"DealNumber","AE","BIST DC","N","int"),
                //new Tag(21103,"TradeReportState","AE","BIST DC","N","int"),
                //new Tag(21104,"TradeReportSubState","AE","BIST DC","N","int"),
                //new Tag(21105,"TradeReportInstrType","AE","BIST DC","N","int"),
                //new Tag(21106,"TraderReportReason","AE","BIST DC","N","???"),
                //new Tag(21107,"AuthorizationState","AE","BIST DC","N","int"),
                //new Tag(21108,"AffimationState","AE","BIST DC","N","???"),
                //new Tag(21109,"DeliveryUnit","AE","BIST DC","N","int"),
                //new Tag(21110,"OrigClearingBusinessDate","AE","BIST DC","N","LocalMktDate"),
                //new Tag(797,"CopyMsgIndicator","AE","BIST DC","N","Boolean"),
                //new Tag(131,"QuoteReqID","R","BIST DC","Q","String"),
                //new Tag(1116,"NoRootPartyIDs","R","BIST DC","N","NumInGroup",new List<Tag>(){
                //    new Tag(1117,"RootPartyID","R","BIST DC","Q","String"),
                //    new Tag(1118,"PartyIDSource","R","BIST DC","Q","???"),
                //    new Tag(1119,"RootPartyRole","R","BIST DC","Q","int"),}),
                //new Tag(146,"NoRelatedSym","R","BIST DC","Q","NumInGroup",new List<Tag>(){
                //    new Tag(55,"Symbol","R","BIST DC","Q","String"),
                //    new Tag(54,"Side","R","BIST DC","N","char"),
                //    new Tag(110,"MinQty","R","BIST DC","N","Qty"),}),
                //new Tag(797,"CopyMsgIndicator","R","BIST DC","N","Boolean"),
                //new Tag(11,"ClOrdID","D","BIST OE","Y","String"),
                //new Tag(453,"NoPartyIDs","D","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","D","BIST OE","Q","String"),
                //    new Tag(447,"PartyIDSource","D","BIST OE","Q","char"),
                //    new Tag(452,"PartyRole","D","BIST OE","Q","int"),}),
                //new Tag(1,"Account","D","BIST OE","Q","String"),
                //new Tag(528,"OrderCapacity","D","BIST OE","Q","char"),
                //new Tag(111,"MaxFloor","D","BIST OE","N","Qty"),
                //new Tag(21,"HandlInst","D","BIST OE","N","char"),
                //new Tag(18,"ExecInst","D","BIST OE","N","MultipleValueString"),
                //new Tag(55,"Instrument/Symbol","D","BIST OE","N","???"),
                //new Tag(48,"Instrument/SecurityID","D","BIST OE","N","???"),
                //new Tag(22,"Instrument/SecurityIDSource","D","BIST OE","N","???"),
                //new Tag(54,"Side","D","BIST OE","Y","char"),
                //new Tag(60,"TransactTime","D","BIST OE","Y","UTCTimestamp"),
                //new Tag(38,"OrderQtyData/OrderQty","D","BIST OE","Y","???"),
                //new Tag(40,"OrdType","D","BIST OE","Y","char"),
                //new Tag(44,"Price","D","BIST OE","N","Price"),
                //new Tag(21101,"UnderlyingColPx","D","BIST OE","N","Price"),
                //new Tag(1100,"TriggeringInstruction/TriggerType","D","BIST OE","N","???"),
                //new Tag(1101,"TriggeringInstruction/TriggerAction","D","BIST OE","N","???"),
                //new Tag(1102,"TriggeringInstruction/TriggerPrice","D","BIST OE","N","???"),
                //new Tag(1113,"TriggeringInstruction/TriggerTradingSessionID","D","BIST OE","N","???"),
                //new Tag(1103,"TriggeringInstruction/TriggerSymbol","D","BIST OE","N","???"),
                //new Tag(1104,"TriggeringInstruction/TriggerSecurityID","D","BIST OE","N","???"),
                //new Tag(1105,"TriggeringInstruction/TriggerSecurityIDSource","D","BIST OE","N","???"),
                //new Tag(1107,"TriggeringInstruction/TriggerPriceType","D","BIST OE","N","???"),
                //new Tag(1109,"TriggeringInstruction/TriggerPriceDirection","D","BIST OE","N","???"),
                //new Tag(59,"TimeInForce","D","BIST OE","Q","char"),
                //new Tag(386,"NoTradingSessions","D","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(336,"TradingSessionID","D","BIST OE","Q","String"),}),
                //new Tag(432,"ExpireDate","D","BIST OE","N","LocalMktDate"),
                //new Tag(70,"AllocID","D","BIST OE","N","String"),
                //new Tag(1089,"MatchIncrement","D","BIST OE","N","Qty"),
                //new Tag(1094,"PegPriceType","D","BIST OE","N","int"),
                //new Tag(20199,"OpenCloseIndicator","D","BIST OE","N","int"),
                //new Tag(41,"OrigClOrdID","F","BIST OE","Y","String"),
                //new Tag(37,"OrderID","F","BIST OE","N","String"),
                //new Tag(11,"ClOrdID","F","BIST OE","Y","String"),
                //new Tag(453,"NoPartyIDs","F","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","F","BIST OE","Q","String"),
                //    new Tag(447,"PartyIDSource","F","BIST OE","Q","char"),
                //    new Tag(452,"PartyRole","F","BIST OE","Q","int"),}),
                //new Tag(55,"Instrument/Symbol","F","BIST OE","N","???"),
                //new Tag(48,"Instrument/SecurityID","F","BIST OE","N","???"),
                //new Tag(22,"Instrument/SecurityIDSource","F","BIST OE","N","???"),
                //new Tag(54,"Side","F","BIST OE","Y","char"),
                //new Tag(60,"TransactTime","F","BIST OE","Y","UTCTimestamp"),
                //new Tag(38,"OrderQtyData/OrderQty","F","BIST OE","Y","???"),
                //new Tag(37,"OrderID","9","BIST OE","Y","String"),
                //new Tag(11,"ClOrdID","9","BIST OE","Y","String"),
                //new Tag(41,"OrigClOrdID","9","BIST OE","Y","String"),
                //new Tag(39,"OrdStatus","9","BIST OE","Y","char"),
                //new Tag(60,"TransactTime","9","BIST OE","Q","UTCTimestamp"),
                //new Tag(434,"CxlRejResponseTo","9","BIST OE","Y","char"),
                //new Tag(102,"CxlRejReason","9","BIST OE","N","int"),
                //new Tag(58,"Text","9","BIST OE","N","String"),
                //new Tag(37,"OrderID","9","BIST OE","Y","String"),
                //new Tag(11,"ClOrdID","9","BIST OE","Y","String"),
                //new Tag(41,"OrigClOrdID","9","BIST OE","Y","String"),
                //new Tag(39,"OrdStatus","9","BIST OE","Y","char"),
                ...
                //new Tag(102,"CxlRejReason","9","BIST OE","N","int"),
                //new Tag(58,"Text","9","BIST OE","N","String"),
                //new Tag(37,"OrderID","8","BIST OE","Y","String"),
                //new Tag(11,"ClOrdID","8","BIST OE","Q","String"),
                //new Tag(453,"NoPartyIDs","8","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","8","BIST OE","Q","String"),
                //    new Tag(447,"PartyIDSource","8","BIST OE","Q","char"),
                //    new Tag(452,"PartyRole","8","BIST OE","Q","int"),}),
                //new Tag(17,"ExecID","8","BIST OE","Y","String"),
                //new Tag(150,"ExecType","8","BIST OE","Y","char"),
                //new Tag(39,"OrdStatus","8","BIST OE","Y","char"),
                //new Tag(1,"Account","8","BIST OE","N","String"),
                //new Tag(528,"OrderCapacity","8","BIST OE","N","char"),
                //new Tag(55,"Instrument/Symbol","8","BIST OE","Q","???"),
                //new Tag(48,"Instrument/SecurityID","8","BIST OE","Q","???"),
                //new Tag(22,"Instrument/SecurityIDSource","8","BIST OE","Q","???"),
                //new Tag(54,"Side","8","BIST OE","Y","char"),
                //new Tag(38,"OrderQtyData/OrderQty","8","BIST OE","Q","???"),
                //new Tag(40,"OrdType","8","BIST OE","Q","char"),
                //new Tag(44,"Price","8","BIST OE","N","Price"),
                //new Tag(21101,"UnderlyingColPx","8","BIST OE","N","Price"),
                //new Tag(1100,"TriggeringInstruction/TriggerType","8","BIST OE","N","???"),
                //new Tag(1101,"TriggeringInstruction/TriggerAction","8","BIST OE","N","???"),
                //new Tag(1102,"TriggeringInstruction/TriggerPrice","8","BIST OE","N","???"),
                //new Tag(1113,"TriggeringInstruction/TriggerTradingSessionID","8","BIST OE","N","???"),
                //new Tag(1103,"TriggeringInstruction/TriggerSymbol","8","BIST OE","N","???"),
                //new Tag(1104,"TriggeringInstruction/TriggerSecurityID","8","BIST OE","N","???"),
                //new Tag(1105,"TriggeringInstruction/TriggerSecurityIDSource","8","BIST OE","N","???"),
                //new Tag(1107,"TriggeringInstruction/TriggerPriceType","8","BIST OE","N","???"),
                //new Tag(1109,"TriggeringInstruction/TriggerPriceDirection","8","BIST OE","N","???"),
                //new Tag(336,"TradingSessionID","8","BIST OE","N","String"),
                //new Tag(59,"TimeInForce","8","BIST OE","Q","char"),
                //new Tag(432,"ExpireDate","8","BIST OE","N","LocalMktDate"),
                //new Tag(18,"ExecInst","8","BIST OE","N","MultipleValueString"),
                //new Tag(151,"LeavesQty","8","BIST OE","Y","Qty"),
                //new Tag(14,"CumQty","8","BIST OE","Y","Qty"),
                //new Tag(6,"AvgPx","8","BIST OE","Y","Price"),
                //new Tag(60,"TransactTime","8","BIST OE","Q","UTCTimestamp"),
                //new Tag(70,"AllocID","8","BIST OE","N","String"),
                //new Tag(797,"CopyMsgIndicator","8","BIST OE","N","Boolean"),
                //new Tag(1089,"MatchIncrement","8","BIST OE","N","Qty"),
                //new Tag(1094,"PegPriceType","8","BIST OE","N","int"),
                //new Tag(111,"MaxFloor","8","BIST OE","N","Qty"),
                //new Tag(119,"SettlCurrAmt","8","BIST OE","N","Amt"),
                //new Tag(20015,"OptionPremiumAmt","8","BIST OE","N","Amt"),
                //new Tag(20199,"OpenCloseIndicator","8","BIST OE","N","int"),
                //new Tag(37,"OrderID","8","BIST OE","Y","String"),
                //new Tag(11,"ClOrdID","8","BIST OE","Q","String"),
                //new Tag(453,"NoPartyIDs","8","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","8","BIST OE","Q","String"),
                ...
                //new Tag(150,"ExecType","8","BIST OE","Y","char"),
                //new Tag(39,"OrdStatus","8","BIST OE","Y","char"),
                //new Tag(103,"OrdRejReason","8","BIST OE","Q","int"),
                //new Tag(55,"Instrument/Symbol","8","BIST OE","Q","???"),
                //new Tag(151,"LeavesQty","8","BIST OE","Y","Qty"),
                //new Tag(14,"CumQty","8","BIST OE","Y","Qty"),
                //new Tag(6,"AvgPx","8","BIST OE","Y","Price"),
                //new Tag(60,"TransactTime","8","BIST OE","Q","UTCTimestamp"),
                //new Tag(58,"Text","8","BIST OE","N","String"),
                //new Tag(37,"OrderID","8","BIST OE","Y","String"),
                //new Tag(11,"ClOrdID","8","BIST OE","Q","String"),
                //new Tag(41,"OrigClOrdID","8","BIST OE","N","String"),
                //new Tag(453,"NoPartyIDs","8","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","8","BIST OE","Q","String"),
                //    new Tag(447,"PartyIDSource","8","BIST OE","Q","char"),
                //    new Tag(452,"PartyRole","8","BIST OE","Q","int"),}),
                ...
                //new Tag(6,"AvgPx","8","BIST OE","Y","Price"),
                //new Tag(60,"TransactTime","8","BIST OE","Q","UTCTimestamp"),
                //new Tag(378,"ExecRestatementReason","8","BIST OE","Q","int"),
                //new Tag(70,"AllocID","8","BIST OE","N","String"),
                //new Tag(119,"SettlCurrAmt","8","BIST OE","N","Amt"),
                //new Tag(20015,"OptionPremiumAmt","8","BIST OE","N","Amt"),
                //new Tag(797,"CopyMsgIndicator","8","BIST OE","N","Boolean"),
                ...
                //    new Tag(447,"PartyIDSource","8","BIST OE","Q","char"),
                //    new Tag(452,"PartyRole","8","BIST OE","Q","int"),}),
                //new Tag(880,"TrdMatchID","8","BIST OE","Q","String"),
                //new Tag(17,"ExecID","8","BIST OE","Y","String"),
                //new Tag(150,"ExecType","8","BIST OE","Y","char"),
                //new Tag(39,"OrdStatus","8","BIST OE","Y","char"),
                //new Tag(1,"Account","8","BIST OE","N","String"),
                ...
                //new Tag(432,"ExpireDate","8","BIST OE","N","LocalMktDate"),
                //new Tag(18,"ExecInst","8","BIST OE","N","MultipleValueString"),
                //new Tag(32,"LastQty","8","BIST OE","Q","Qty"),
                //new Tag(31,"LastPx","8","BIST OE","Q","Price"),
                //new Tag(21100,"LastUnderlyingPx","8","BIST OE","N","Price"),
                //new Tag(151,"LeavesQty","8","BIST OE","Y","Qty"),
                //new Tag(14,"CumQty","8","BIST OE","Y","Qty"),
                //new Tag(6,"AvgPx","8","BIST OE","Y","Price"),
                //new Tag(60,"TransactTime","8","BIST OE","Q","UTCTimestamp"),
                ...
                //new Tag(22,"Instrument/SecurityIDSource","8","BIST OE","Q","???"),
                //new Tag(54,"Side","8","BIST OE","Y","char"),
                //new Tag(38,"OrderQtyData/OrderQty","8","BIST OE","N","???"),
                //new Tag(40,"OrdType","8","BIST OE","Q","char"),
                //new Tag(44,"Price","8","BIST OE","N","Price"),
                //new Tag(21101,"UnderlyingColPx","8","BIST OE","N","Price"),
                //new Tag(59,"TimeInForce","8","BIST OE","Q","char"),
                ...
                //new Tag(1089,"MatchIncrement","8","BIST OE","N","Qty"),
                //new Tag(20199,"OpenCloseIndicator","8","BIST OE","N","int"),
                //new Tag(45,"RefSeqNum","j","BIST OE","N","SeqNum"),
                //new Tag(372,"RefMsgType","j","BIST OE","Y","String"),
                //new Tag(380,"BusinessRejectReason","j","BIST OE","Y","int"),
                //new Tag(58,"Text","j","BIST OE","N","String"),
                //new Tag(320,"SecurityReqID","c","BIST OE","Y","String"),
                //new Tag(321,"SecurityRequestType","c","BIST OE","Y","int"),
                //new Tag(55,"Instrument/Symbol","c","BIST OE","Y","???"),
                //new Tag(555,"NoLegs","c","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(600,"LegSymbol","c","BIST OE","Q","String"),
                //    new Tag(602,"LegSecurityID","c","BIST OE","N","String"),
                //    new Tag(603,"LegSecurityIDSource","c","BIST OE","N","String"),
                //    new Tag(624,"LegSide","c","BIST OE","Q","char"),
                //    new Tag(623,"LegRatioQty","c","BIST OE","Q","float"),}),
                //new Tag(320,"SecurityReqID","c","BIST OE","Y","String"),
                //new Tag(321,"SecurityRequestType","c","BIST OE","Y","int"),
                //new Tag(55,"Symbol","c","BIST OE","N","String"),
                //new Tag(48,"SecurityID","c","BIST OE","N","String"),
                //new Tag(22,"SecurityIDSource","c","BIST OE","N","String"),
                //new Tag(864,"NoEvents","c","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(865,"EventType","c","BIST OE","Q","int"),
                //    new Tag(866,"EventDate","c","BIST OE","Q","LocalMktDate"),}),
                //new Tag(320,"SecurityReqID","c","BIST OE","Y","String"),
                //new Tag(321,"SecurityRequestType","c","BIST OE","Y","int"),
                //new Tag(55,"Symbol","c","BIST OE","N","String"),
                //new Tag(48,"SecurityID","c","BIST OE","N","String"),
                //new Tag(22,"SecurityIDSource","c","BIST OE","N","String"),
                //new Tag(1147,"UnitOfMeasureQty","c","BIST OE","Q","Qty"),
                //new Tag(21060,"Fineness","c","BIST OE","Q","Qty"),
                //new Tag(864,"NoEvents","c","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(865,"EventType","c","BIST OE","Q","int"),
                //    new Tag(866,"EventDate","c","BIST OE","Q","LocalMktDate"),}),
                //new Tag(320,"SecurityReqID","c","BIST OE","Y","String"),
                ...
                //new Tag(48,"SecurityID","c","BIST OE","N","String"),
                //new Tag(22,"SecurityIDSource","c","BIST OE","N","String"),
                //new Tag(202,"StrikePrice","c","BIST OE","N","Price"),
                //new Tag(864,"NoEvents","c","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(865,"EventType","c","BIST OE","Q","int"),
                //    new Tag(866,"EventDate","c","BIST OE","Q","LocalMktDate"),}),
                //new Tag(320,"SecurityReqID","d","BIST OE","Y","String"),
                //new Tag(323,"SecurityResponseType","d","BIST OE","Q","int"),
                //new Tag(55,"Instrument/Symbol","d","BIST OE","Q","???"),
                //new Tag(48,"Instrument/SecurityID","d","BIST OE","Q","???"),
                //new Tag(22,"Instrument/SecurityIDSource","d","BIST OE","N","???"),
                //new Tag(20013,"DeferredPublicationTime","d","BIST OE","N","int"),
                //new Tag(1940,"AssetType","d","BIST OE","N","String"),
                //new Tag(1938,"AssetClass","d","BIST OE","N","int"),
                //new Tag(1939,"AssetSubClass","d","BIST OE","N","int"),
                //new Tag(996,"UnitOfMeasure","d","BIST OE","N","String"),
                //new Tag(21061,"FinenessNotation","d","BIST OE","N","int"),
                //new Tag(21062,"MetalWeightConversionFactor","d","BIST OE","N","Qty"),
                //new Tag(21060,"Fineness","d","BIST OE","N","Qty"),
                //new Tag(1147,"UnitOfMeasureQty","d","BIST OE","N","Qty"),
                //new Tag(2304,"NoAssetAttributes","d","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(2305,"AssetAttributeType","d","BIST OE","N","String"),
                //    new Tag(2306,"AssetAttributeValue","d","BIST OE","N","String"),}),
                //new Tag(320,"SecurityReqID","d","BIST OE","Y","String"),
                //new Tag(323,"SecurityResponseType","d","BIST OE","Q","int"),
                //new Tag(58,"Text","d","BIST OE","Q","String"),
                //new Tag(320,"SecurityReqID","BP","BIST OE","Y","String"),
                //new Tag(980,"SecurityUpdateAction","BP","BIST OE","Q","char"),
                //new Tag(55,"Symbol","BP","BIST OE","Q","String"),
                //new Tag(48,"SecurityID","BP","BIST OE","Q","String"),
                //new Tag(22,"SecurityIDSource","BP","BIST OE","Q","String"),
                //new Tag(454,"NoSecurityAltID","BP","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(455,"SecurityAltID","BP","BIST OE","Q","String"),
                //    new Tag(456,"SecurityAltIDSource","BP","BIST OE","N","String"),}),
                //new Tag(555,"NoLegs","BP","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(600,"LegSymbol","BP","BIST OE","N","String"),
                //    new Tag(602,"LegSecurityID","BP","BIST OE","N","String"),
                //    new Tag(603,"LegSecurityIDSource","BP","BIST OE","N","String"),
                //    new Tag(623,"LegRatioQty","BP","BIST OE","N","float"),
                //    new Tag(624,"LegSide","BP","BIST OE","N","char"),}),
                //new Tag(1940,"AssetType","BP","BIST OE","N","String"),
                //new Tag(1938,"AssetClass","BP","BIST OE","N","int"),
                //new Tag(1939,"AssetSubClass","BP","BIST OE","N","int"),
                //new Tag(996,"UnitOfMeasure","BP","BIST OE","N","String"),
                //new Tag(21061,"FinenessNotation","BP","BIST OE","N","int"),
                //new Tag(21062,"MetalWeightConversionFactor","BP","BIST OE","N","Qty"),
                //new Tag(21060,"Fineness","BP","BIST OE","N","Qty"),
                //new Tag(1147,"UnitOfMeasureQty","BP","BIST OE","N","Qty"),
                //new Tag(2304,"NoAssetAttributes","BP","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(2305,"AssetAttributeType","BP","BIST OE","N","String"),
                //    new Tag(2306,"AssetAttributeValue","BP","BIST OE","N","String"),}),
                //new Tag(37,"OrderID","8","BIST OE","Y","String"),
                //new Tag(11,"ClOrdID","8","BIST OE","Q","String"),
                //new Tag(453,"NoPartyIDs","8","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","8","BIST OE","Q","String"),
                ...
                //    new Tag(452,"PartyRole","8","BIST OE","Q","int"),}),
                //new Tag(880,"TrdMatchID","8","BIST OE","Q","String"),
                //new Tag(20034,"ComboMatchID","8","BIST OE","Q","???"),
                //new Tag(17,"ExecID","8","BIST OE","Y","String"),
                //new Tag(150,"ExecType","8","BIST OE","Y","char"),
                //new Tag(39,"OrdStatus","8","BIST OE","Y","char"),
                //new Tag(1,"Account","8","BIST OE","N","String"),
                ...
                //new Tag(54,"Side","8","BIST OE","Y","char"),
                //new Tag(40,"OrdType","8","BIST OE","Q","char"),
                //new Tag(44,"Price","8","BIST OE","Q","Price"),
                //new Tag(59,"TimeInForce","8","BIST OE","Q","char"),
                //new Tag(336,"TradingSessionID","8","BIST OE","N","String"),
                //new Tag(32,"LastQty","8","BIST OE","N","Qty"),
                //new Tag(31,"LastPx","8","BIST OE","N","Price"),
                //new Tag(151,"LeavesQty","8","BIST OE","Y","Qty"),
                //new Tag(14,"CumQty","8","BIST OE","Y","Qty"),
                //new Tag(6,"AvgPx","8","BIST OE","Y","Price"),
                //new Tag(60,"TransactTime","8","BIST OE","Y","UTCTimestamp"),
                //new Tag(442,"MultiLegReportingType","8","BIST OE","Q","char"),
                //new Tag(555,"NoLegs","8","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(600,"LegSymbol","8","BIST OE","Q","String"),
                //    new Tag(602,"LegSecurityID","8","BIST OE","Q","String"),
                //    new Tag(603,"LegSecurityIDSource","8","BIST OE","Q","String"),
                //    new Tag(637,"LegLastPx","8","BIST OE","Q","Price"),
                //    new Tag(1418,"LegLastQty","8","BIST OE","Q","Qty"),
                //    new Tag(20200,"LegTrdMatchID","8","BIST OE","Q","String"),}),
                //new Tag(70,"AllocID","8","BIST OE","N","String"),
                //new Tag(797,"CopyMsgIndicator","8","BIST OE","N","Boolean"),
                //new Tag(20199,"OpenCloseIndicator","8","BIST OE","N","int"),
                //new Tag(117,"QuoteID","b","BIST OE","Q","String"),
                //new Tag(297,"QuoteStatus","b","BIST OE","Y","int"),
                //new Tag(300,"QuoteRejectReason","b","BIST OE","N","int"),
                //new Tag(301,"QuoteResponseLevel","b","BIST OE","Q","int"),
                //new Tag(537,"QuoteType","b","BIST OE","Q","int"),
                //new Tag(453,"NoPartyIDs","b","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","b","BIST OE","Q","String"),
                //    new Tag(447,"PartyIDSource","b","BIST OE","Q","char"),
                //    new Tag(452,"PartyRole","b","BIST OE","Q","int"),}),
                //new Tag(58,"Text","b","BIST OE","N","String"),
                //new Tag(131,"QuoteReqID","R","BIST OE","Q","String"),
                //new Tag(146,"NoRelatedSym","R","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(55,"Intrumetn/Symbol","R","BIST OE","Y","???"),
                //    new Tag(48,"Instrument/SecurityID","R","BIST OE","N","???"),
                //    new Tag(22,"Instrument/SecurityIDSource","R","BIST OE","N","???"),
                //    new Tag(54,"Side","R","BIST OE","N","char"),
                //    new Tag(110,"MinQty","R","BIST OE","N","Qty"),}),
                //new Tag(1116,"NoRootParyIDs","R","BIST OE","N","???",new List<Tag>(){
                //    new Tag(1117,"RootPartyID","R","BIST OE","Q","String"),}),
                //new Tag(1118,"RootPartyIDSource","R","BIST OE","Q","char"),
                //new Tag(1119,"RootPartyRole","R","BIST OE","Q","int"),
                //new Tag(131,"QuoteReqID","R","BIST OE","Q","String"),
                //new Tag(1116,"NoRootPartyIDs","R","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(1117,"RootPartyID","R","BIST OE","Q","String"),
                //    new Tag(1118,"PartyIDSource","R","BIST OE","Q","???"),
                //    new Tag(1119,"RootPartyRole","R","BIST OE","Q","int"),}),
                //new Tag(146,"NoRelatedSym","R","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(55,"Symbol","R","BIST OE","Q","String"),
                //    new Tag(54,"Side","R","BIST OE","N","char"),
                //    new Tag(110,"MinQty","R","BIST OE","N","Qty"),}),
                //new Tag(131,"QuoteReqID","AG","BIST OE","Y","String"),
                //new Tag(658,"QuoteRequstRejectReason","AG","BIST OE","Y","???"),
                //new Tag(146,"NoRelatedSym","AG","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(55,"Intrumetn/Symbol","AG","BIST OE","Y","???"),
                //    new Tag(48,"Instrument/SecurityID","AG","BIST OE","Q","???"),
                //    new Tag(22,"Instrument/SecurityIDSource","AG","BIST OE","Q","???"),}),
                //new Tag(58,"Text","AG","BIST OE","N","String"),
                //new Tag(571,"TradeReportID","AE","BIST OE","Y","String"),
                //new Tag(487,"TradeReportTransType","AE","BIST OE","Q","int"),
                //new Tag(856,"TradeReportType","AE","BIST OE","Q","int"),
                //new Tag(828,"TrdType","AE","BIST OE","Q","int"),
                //new Tag(570,"PreviouslyReported","AE","BIST OE","Y","Boolean"),
                //new Tag(1116,"NoRootPartyIDs","AE","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(1117,"RootPartyID","AE","BIST OE","Q","String"),
                //    new Tag(1118,"RootPartyIDSource","AE","BIST OE","Q","char"),
                //    new Tag(1119,"RootPartyRole","AE","BIST OE","Q","int"),}),
                //new Tag(55,"Instrument/Symbol","AE","BIST OE","N","???"),
                //new Tag(48,"Instrument/SecurityID","AE","BIST OE","N","???"),
                //new Tag(22,"Instrument/SecurityIDSource","AE","BIST OE","N","???"),
                //new Tag(32,"LastQty","AE","BIST OE","Y","Qty"),
                //new Tag(31,"LastPx","AE","BIST OE","Y","Price"),
                //new Tag(21100,"LastUnderlyingPx","AE","BIST OE","N","Price"),
                //new Tag(75,"TradeDate","AE","BIST OE","Y","LocalMktDate"),
                //new Tag(60,"TransactTime","AE","BIST OE","Y","UTCTimestamp"),
                //new Tag(64,"SettlDate","AE","BIST OE","N","LocalMktDate"),
                //new Tag(552,"NoSides","AE","BIST OE","Y","NumInGroup",new List<Tag>(){
                //    new Tag(54,"Side","AE","BIST OE","Y","char"),
                //    new Tag(37,"OrderID","AE","BIST OE","Y","String"),
                //    new Tag(453,"NoPartyIDs","AE","BIST OE","Q","NumInGroup",new List<Tag>(){
                //        new Tag(448,"PartyID","AE","BIST OE","Q","String"),
                //        new Tag(447,"PartyIDSource","AE","BIST OE","Q","char"),
                //        new Tag(452,"PartyRole","AE","BIST OE","Q","int"),}),
                //    new Tag(1,"Account","AE","BIST OE","N","String"),
                //    new Tag(528,"OrderCapacity","AE","BIST OE","N","char"),
                //    new Tag(70,"AllocID","AE","BIST OE","N","String"),
                //    new Tag(483,"TransBkdTime","AE","BIST OE","N","UTCTimestamp"),
                //    new Tag(20199,"OpenCloseIndicator","AE","BIST OE","N","int"),}),
                //new Tag(571,"TradeReportID","AE","BIST OE","Y","String"),
                //new Tag(487,"TradeReportTransType","AE","BIST OE","Q","int"),
                //new Tag(856,"TradeReportType","AE","BIST OE","Q","int"),
                //new Tag(828,"TrdType","AE","BIST OE","Q","int"),
                ...
                //    new Tag(70,"AllocID","AE","BIST OE","N","String"),
                //    new Tag(20199,"OpenCloseIndicator","AE","BIST OE","N","int"),}),
                //new Tag(571,"TradeReportID","AR","BIST OE","Y","String"),
                //new Tag(818,"SecondaryTradeReportID","AR","BIST OE","N","String"),
                //new Tag(150,"ExecType","AR","BIST OE","Y","char"),
                //new Tag(939,"TradeRptStatus","AR","BIST OE","Q","???"),
                //new Tag(55,"Instrument/Symbol","AR","BIST OE","Q","???"),
                //new Tag(48,"Instrument/SecurityID","AR","BIST OE","Q","???"),
                //new Tag(22,"Instrument/SecurityIDSource","AR","BIST OE","Q","???"),
                //new Tag(70,"AllocID","AR","BIST OE","N","String"),
                //new Tag(1,"Account","AR","BIST OE","N","String"),
                //new Tag(528,"OrderCapacity","AR","BIST OE","N","char"),
                //new Tag(1116,"NoRootPartyIDs","AR","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(1117,"RootPartyID","AR","BIST OE","Q","String"),
                //    new Tag(1118,"RootPartyIDSource","AR","BIST OE","Q","char"),
                //    new Tag(1119,"RootPartyRole","AR","BIST OE","Q","int"),}),
                //new Tag(797,"CopyMsgIndicator","AR","BIST OE","N","Boolean"),
                //new Tag(571,"TradeReportID","AR","BIST OE","Y","String"),
                //new Tag(150,"ExecType","AR","BIST OE","Y","char"),
                //new Tag(939,"TradeRptStatus","AR","BIST OE","Q","???"),
                //new Tag(751,"TradeReportRejectReason","AR","BIST OE","Q","int"),
                //new Tag(55,"Instrument/Symbol","AR","BIST OE","Y","???"),
                //new Tag(58,"Text","AR","BIST OE","N","String"),
                //new Tag(571,"TradeReportID","AE","BIST OE","Y","String"),
                //new Tag(487,"TradeReportTransType","AE","BIST OE","Q","int"),
                //new Tag(856,"TradeReportType","AE","BIST OE","Q","int"),
                //new Tag(828,"TrdType","AE","BIST OE","Q","int"),
                //new Tag(573,"MatchStatus","AE","BIST OE","Q","char"),
                //new Tag(570,"PreviouslyReported","AE","BIST OE","Y","Boolean"),
                //new Tag(55,"Instrument/Symbol","AE","BIST OE","Q","???"),
                //new Tag(48,"Instrument/SecurityID","AE","BIST OE","Q","???"),
                //new Tag(22,"Instrument/SecurityIDSource","AE","BIST OE","Q","???"),
                //new Tag(32,"LastQty","AE","BIST OE","Y","Qty"),
                //new Tag(31,"LastPx","AE","BIST OE","Y","Price"),
                //new Tag(21100,"LastUnderlyingPx","AE","BIST OE","N","Price"),
                //new Tag(75,"TradeDate","AE","BIST OE","Y","LocalMktDate"),
                ...
                //        new Tag(452,"PartyRole","AE","BIST OE","Q","int"),}),
                //    new Tag(483,"TransBkdTime","AE","BIST OE","N","UTCTimestamp"),}),
                //new Tag(797,"CopyMsgIndicator","AE","BIST OE","N","Boolean"),
                //new Tag(571,"TradeReportID","AE","BIST OE","Y","String"),
                //new Tag(572,"TradeReportRefID","AE","BIST OE","N","String"),
                //new Tag(487,"TradeReportTransType","AE","BIST OE","Q","int"),
                //new Tag(856,"TradeReportType","AE","BIST OE","Q","int"),
                //new Tag(828,"TrdType","AE","BIST OE","Q","int"),
                //new Tag(573,"MatchStatus","AE","BIST OE","Q","char"),
                ...
                //new Tag(797,"CopyMsgIndicator","AE","BIST OE","N","Boolean"),
                //new Tag(571,"TradeReportID","AE","BIST OE","Y","String"),
                //new Tag(1003,"TradeID","AE","BIST OE","Q","String"),
                //new Tag(572,"TradeReportRefID","AE","BIST OE","Q","String"),
                //new Tag(818,"SecondaryTradeReportID","AE","BIST OE","Q","String"),
                //new Tag(487,"TradeReportTransType","AE","BIST OE","Q","int"),
                //new Tag(856,"TradeReportType","AE","BIST OE","Q","int"),
                //new Tag(828,"TrdType","AE","BIST OE","N","int"),
                //new Tag(573,"MatchStatus","AE","BIST OE","Q","char"),
                //new Tag(880,"TrdMatchID","AE","BIST OE","Q","String"),
                //new Tag(570,"PreviouslyReported","AE","BIST OE","Y","Boolean"),
                //new Tag(55,"Instrument/Symbol","AE","BIST OE","Q","???"),
                //new Tag(48,"Instrument/SecurityID","AE","BIST OE","Q","???"),
                //new Tag(22,"Instrument/SecurityIDSource","AE","BIST OE","Q","???"),
                ...
                //        new Tag(452,"PartyRole","AE","BIST OE","Q","int"),}),
                //    new Tag(483,"TransBkdTime","AE","BIST OE","N","UTCTimestamp"),
                //    new Tag(20009,"OrderReference","AE","BIST OE","N","String"),
                //    new Tag(77,"PositionEffect","AE","BIST OE","N","char"),
                //    new Tag(70,"AllocID","AE","BIST OE","N","String"),}),
                //new Tag(715,"ClearingBusinessDate","AE","BIST OE","N","LocalMktDate"),
                //new Tag(21102,"DealNumber","AE","BIST OE","N","int"),
                //new Tag(21103,"TradeReportState","AE","BIST OE","Q","int"),
                //new Tag(21104,"TradeReportSubState","AE","BIST OE","Q","int"),
                //new Tag(21105,"TradeReportInstrType","AE","BIST OE","N","int"),
                //new Tag(21106,"TraderReportReason","AE","BIST OE","N","???"),
                //new Tag(21107,"AuthorizationState","AE","BIST OE","N","int"),
                //new Tag(21108,"AffimationState","AE","BIST OE","N","???"),
                //new Tag(21109,"DeliveryUnit","AE","BIST OE","N","int"),
                //new Tag(21110,"OrigClearingBusinessDate","AE","BIST OE","N","LocalMktDate"),
                //new Tag(571,"TradeReportID","AR","BIST OE","Y","String"),
                //new Tag(487,"TradeReportTransType","AR","BIST OE","Q","int"),
                //new Tag(818,"SecondaryTradeReportID","AR","BIST OE","Q","String"),
                //new Tag(150,"ExecType","AR","BIST OE","Y","char"),
                //new Tag(939,"TradeRptStatus","AR","BIST OE","Q","???"),
                //new Tag(55,"Instrument/Symbol","AR","BIST OE","Q","???"),
                //new Tag(48,"Instrument/SecurityID","AR","BIST OE","Q","???"),
                ...
                //new Tag(571,"TradeReportID","AE","BIST OE","Y","String"),
                //new Tag(572,"TradeReportRefID","AE","BIST OE","N","String"),
                //new Tag(881,"SecondaryTradeReportRefID","AE","BIST OE","N","String"),
                //new Tag(487,"TradeReportTransType","AE","BIST OE","Q","int"),
                //new Tag(856,"TradeReportType","AE","BIST OE","Q","int"),
                //new Tag(570,"PreviouslyReported","AE","BIST OE","Y","Boolean"),
                //new Tag(1116,"NoRootPartyIDs","AE","BIST OE","N","NumInGroup",new List<Tag>(){
                ...
                //    new Tag(54,"Side","AE","BIST OE","Y","char"),
                //    new Tag(37,"OrderID","AE","BIST OE","Y","String"),
                //    new Tag(826,"TradeAllocIndicator","AE","BIST OE","N","int"),
                //    new Tag(78,"NoAllocs","AE","BIST OE","Q","NumInGroup",new List<Tag>(){
                //        new Tag(79,"AllocAccount","AE","BIST OE","Y","String"),
                //        new Tag(756,"NoNested2PartyIDs","AE","BIST OE","Q","NumInGroup"),}),
                //    new Tag(757,"Nested2PartyID","AE","BIST OE","N","String"),
                //    new Tag(758,"Nested2PartyIDSource","AE","BIST OE","N","char"),
                //    new Tag(759,"Nested2PartyRole","AE","BIST OE","N","int",new List<Tag>(){
                //        new Tag(467,"IndividualAllocID","AE","BIST OE","N","String"),
                //        new Tag(528,"OrderCapacity","AE","BIST OE","Y","char"),}),}),
                //new Tag(571,"TradeReportID","AR","BIST OE","Y","String"),
                //new Tag(487,"TradeReportTransType","AR","BIST OE","Q","int"),
                //new Tag(1003,"TradeID","AR","BIST OE","Q","String"),
                //new Tag(150,"ExecType","AR","BIST OE","Y","char"),
                //new Tag(939,"TradeRptStatus","AR","BIST OE","Q","???"),
                //new Tag(55,"Instrument/Symbol","AR","BIST OE","Q","???"),
                //new Tag(48,"Instrument/SecurityID","AR","BIST OE","Q","???"),
                ...
                //new Tag(55,"Instrument/Symbol","AR","BIST OE","Y","???"),
                //new Tag(58,"Text","AR","BIST OE","N","String"),
                //new Tag(70,"AllocID","J","BIST OE","Y","String"),
                //new Tag(71,"AllocTransType","J","BIST OE","Q","char"),
                //new Tag(626,"AllocType","J","BIST OE","Q","int"),
                //new Tag(124,"NoExecs","J","BIST OE","Q","NumInGroup"),
                //new Tag(32,"LastQty","J","BIST OE","Q","Qty"),
                //new Tag(1003,"TradeID","J","BIST OE","Q","String"),
                //new Tag(54,"Side","J","BIST OE","Y","char"),
                //new Tag(55,"Instrument/Symbol","J","BIST OE","N","???"),
                //new Tag(48,"Instrument/SecurityID","J","BIST OE","N","???"),
                //new Tag(22,"Instrument/SecurityIDSource","J","BIST OE","N","???"),
                //new Tag(53,"Quantity","J","BIST OE","Y","Qty"),
                //new Tag(75,"TradeDate","J","BIST OE","Y","LocalMktDate"),
                //new Tag(78,"NoAllocs","J","BIST OE","Y","NumInGroup",new List<Tag>(){
                //    new Tag(79,"AllocAccount","J","BIST OE","Y","String"),
                //    new Tag(80,"AllocQty","J","BIST OE","Q","Qty"),
                //    new Tag(539,"NoNestedPartyIDs","J","BIST OE","Q","NumInGroup",new List<Tag>(){
                //        new Tag(524,"NestedPartyID","J","BIST OE","Q","String"),
                //        new Tag(525,"NestedPartyIDSource","J","BIST OE","Q","char"),
                //        new Tag(538,"NestedPartyRole","J","BIST OE","Q","int"),}),
                //    new Tag(12,"Commission","J","BIST OE","N","Amt"),
                //    new Tag(13,"CommType","J","BIST OE","N","char"),}),
                //new Tag(58,"Text","J","BIST OE","N","String"),
                //new Tag(755,"AllocReportID","AT","BIST OE","Y","String"),
                //new Tag(70,"AllocID","AT","BIST OE","Y","String"),
                //new Tag(71,"AllocTransType","AT","BIST OE","Q","char"),
                //new Tag(87,"AllocStatus","AT","BIST OE","Q","int"),
                //new Tag(88,"AllocRejCode","AT","BIST OE","Q","int"),
                //new Tag(58,"Text","AT","BIST OE","N","String"),
                //new Tag(755,"AllocReportID","AT","BIST OE","N","String"),
                //new Tag(70,"AllocID","AT","BIST OE","N","String"),
                //new Tag(793,"SecondaryAllocID","AT","BIST OE","Q","String"),
                //new Tag(71,"AllocTransType","AT","BIST OE","Q","char"),
                //new Tag(794,"AllocReportType","AT","BIST OE","Q","int"),
                //new Tag(87,"AllocStatus","AT","BIST OE","Y","int"),
                //new Tag(715,"ClearingBusinessDate","AT","BIST OE","N","LocalMktDate"),
                //new Tag(54,"Side","AT","BIST OE","Q","char"),
                //new Tag(124,"NoExecs","AT","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(32,"LastQty","AT","BIST OE","Y","Qty"),
                //    new Tag(31,"LastPx","AT","BIST OE","N","Price"),
                //    new Tag(1003,"TradeID","AT","BIST OE","Q","String"),}),
                //new Tag(55,"Instrument/Symbol","AT","BIST OE","N","???"),
                //new Tag(48,"Instrument/SecurityID","AT","BIST OE","N","???"),
                //new Tag(22,"Instrument/SecurityIDSource","AT","BIST OE","N","???"),
                //new Tag(53,"Quantity","AT","BIST OE","Y","Qty"),
                //new Tag(30,"LastMkt","AT","BIST OE","N","Exchange"),
                //new Tag(6,"AvgPx","AT","BIST OE","Y","Price"),
                //new Tag(453,"NoPartyIDs","AT","BIST OE","Q","NumInGroup",new List<Tag>(){
                //    new Tag(448,"PartyID","AT","BIST OE","Q","String"),
                //    new Tag(447,"PartyIDSource","AT","BIST OE","Q","char"),
                //    new Tag(452,"PartyRole","AT","BIST OE","Q","int"),}),
                //new Tag(70,"AllocID","J","BIST OE","Y","String"),
                //new Tag(71,"AllocTransType","J","BIST OE","Q","char"),
                //new Tag(626,"AllocType","J","BIST OE","Q","int"),
                //new Tag(54,"Side","J","BIST OE","Y","char"),
                ...
                //    new Tag(79,"AllocAccount","J","BIST OE","Y","String"),
                //    new Tag(80,"AllocQty","J","BIST OE","Q","Qty"),
                //    new Tag(1047,"AllocPositionEffect","J","BIST OE","N","char"),
                //    new Tag(539,"NoNestedPartyIDs","J","BIST OE","Q","NumInGroup",new List<Tag>(){
                //        new Tag(524,"NestedPartyID","J","BIST OE","Q","String"),
                //        new Tag(525,"NestedPartyIDSource","J","BIST OE","Q","char"),
                //        new Tag(538,"NestedPartyRole","J","BIST OE","Q","int"),}),
                //    new Tag(161,"AllocText","J","BIST OE","N","String"),}),
                //new Tag(70,"AllocID","J","BIST OE","Y","String"),
                //new Tag(71,"AllocTransType","J","BIST OE","Q","char"),
                //new Tag(626,"AllocType","J","BIST OE","Q","int"),
                //new Tag(54,"Side","J","BIST OE","Y","char"),
                ...
                //new Tag(571,"TradeReportID","AE","BIST OE","Y","String"),
                //new Tag(1003,"TradeID","AE","BIST OE","Q","String"),
                //new Tag(1040,"SecondaryTradeID","AE","BIST OE","N","String"),
                //new Tag(1126,"OrigTradeID","AE","BIST OE","N","String"),
                //new Tag(1127,"OrigSecondaryTradeID","AE","BIST OE","N","String"),
                //new Tag(487,"TradeReportTransType","AE","BIST OE","Q","int"),
                //new Tag(856,"TradeReportType","AE","BIST OE","Q","int"),
                //new Tag(829,"TrdSubType","AE","BIST OE","Q","int"),
                //new Tag(573,"MatchStatus","AE","BIST OE","Q","char"),
                //new Tag(730,"SettlementPrice","AE","BIST OE","N","???"),
                //new Tag(20017,"WithHoldingTax","AE","BIST OE","N","Price"),
                //new Tag(20018,"RepoInterestAmt","AE","BIST OE","N","Price"),
                //new Tag(1703,"NoCollateralAmounts","AE","BIST OE","N","NumInGroup",new List<Tag>(){
                //    new Tag(1704,"CurrentCollateralAmount","AE","BIST OE","N","long"),}),
                //new Tag(20007,"CorrespondingPrice","AE","BIST OE","N","Price"),
                //new Tag(20008,"Consideration","AE","BIST OE","N","Price"),
                //new Tag(880,"TrdMatchID","AE","BIST OE","Q","String"),
                //new Tag(20034,"ComboMatchID","AE","BIST OE","N","???"),
                //new Tag(570,"PreviouslyReported","AE","BIST OE","Y","Boolean"),
                //new Tag(55,"Instrument/Symbol","AE","BIST OE","Q","???"),
                //new Tag(48,"Instrument/SecurityID","AE","BIST OE","Q","???"),
                //new Tag(22,"Instrument/SecurityIDSource","AE","BIST OE","Q","???"),
                //new Tag(38,"OrderQtyData/OrderQty","AE","BIST OE","N","???"),
                //new Tag(32,"LastQty","AE","BIST OE","Y","Qty"),
                //new Tag(31,"LastPx","AE","BIST OE","Y","Price"),
                //new Tag(21100,"LastUnderlyingPx","AE","BIST OE","N","Price"),
                //new Tag(75,"TradeDate","AE","BIST OE","Y","LocalMktDate"),
                ...
                //    new Tag(528,"OrderCapacity","AE","BIST OE","N","char"),
                //    new Tag(70,"AllocID","AE","BIST OE","N","String"),
                //    new Tag(1057,"AggressorIndicator","AE","BIST OE","N","Boolean"),}),
                //new Tag(381,"GrossTradeAmt","AE","BIST OE","N","Amt"),
                //new Tag(20015,"OptionPremiumAmt","AE","BIST OE","N","Amt"),
                //new Tag(715,"ClearingBusinessDate","AE","BIST OE","N","LocalMktDate"),
                //new Tag(855,"SecondaryTrdType","AE","BIST OE","N","int"),
                //new Tag(793,"SecondaryAllocID","AE","BIST OE","N","String"),
                //new Tag(797,"CopyMsgIndicator","AE","BIST OE","N","Boolean"),
                //new Tag(571,"TradeReportID","AE","BIST OE","Y","String"),
                //new Tag(1003,"TradeID","AE","BIST OE","Q","String"),
                //new Tag(1126,"OrigTradeID","AE","BIST OE","N","String"),
                ...
                //    new Tag(1,"Account","AE","BIST OE","N","String"),
                //    new Tag(528,"OrderCapacity","AE","BIST OE","N","char"),
                //    new Tag(70,"AllocID","AE","BIST OE","N","String",new List<Tag>(){
                //        new Tag(223,"CouponRate","d","BIST RD","N","Percentage"),
                //        new Tag(224,"CouponPaymentDate","d","BIST RD","N","LocalMktDate"),}),}),
                //new Tag(715,"ClearingBusinessDate","AE","BIST OE","N","LocalMktDate"),
                //new Tag(855,"SecondaryTrdType","AE","BIST OE","N","int"),
                //new Tag(793,"SecondaryAllocID","AE","BIST OE","N","String"),
                //new Tag(797,"CopyMsgIndicator","AE","BIST OE","N","Boolean"),
                //new Tag(98,"EncryptMethod","A","BIST RD","Y","int"),
                //new Tag(108,"HeartBtInt","A","BIST RD","Y","int"),
                //new Tag(141,"ResetSeqNumFlag","A","BIST RD","Q","Boolean"),
                //new Tag(553,"Username","A","BIST RD","Q","String"),
                //new Tag(554,"Password","A","BIST RD","Q","String"),
                //new Tag(925,"NewPassword","A","BIST RD","N","String"),
                //new Tag(1137,"DefaultApplVerID","A","BIST RD","Y","String"),
                //new Tag(98,"EncryptMethod","A","BIST RD","Y","int"),
                //new Tag(108,"HeartBtInt","A","BIST RD","Y","int"),
                //new Tag(141,"ResetSeqNumFlag","A","BIST RD","Q","Boolean"),
                //new Tag(1409,"SessionStatus","A","BIST RD","Q","int"),
                //new Tag(1137,"DefaultApplVerID","A","BIST RD","Y","String"),
                //new Tag(20002,"DaysToPwdExpiry","A","BIST RD","N","int"),
                //new Tag(1409,"SessionStatus","5","BIST RD","N","int"),
                //new Tag(58,"Text","5","BIST RD","N","String"),
                //new Tag(123,"GapFillFlag","4","BIST RD","N","Boolean"),
                //new Tag(36,"NewSeqNo","4","BIST RD","Y","SeqNum"),
                //new Tag(7,"BeginSeqNo","2","BIST RD","Y","SeqNum"),
                //new Tag(16,"EndSeqNo","2","BIST RD","Y","SeqNum"),
                //new Tag(112,"TestReqID","0","BIST RD","N","String"),
                //new Tag(112,"TestReqID","1","BIST RD","Y","String"),
                //new Tag(45,"RefSeqNum","3","BIST RD","Y","SeqNum"),
                //new Tag(371,"RefTagID","3","BIST RD","N","int"),
                //new Tag(372,"RefMsgType","3","BIST RD","N","String"),
                //new Tag(373,"SessionRejectReason","3","BIST RD","Q","int"),
                //new Tag(58,"Text","3","BIST RD","N","String"),
                //new Tag(1180,"ApplicationSequenceControl/ApplID","d","BIST RD","Q","???"),
                //new Tag(1181,"ApplicationSequenceControl/ApplSeqNum","d","BIST RD","Q","???"),
                //new Tag(1350,"ApplicationSequenceControl/ApplLastSeqNum","d","BIST RD","Q","???"),
                //new Tag(55,"Symbol","d","BIST RD","Q","String"),
                //new Tag(107,"SecurityDesc","d","BIST RD","N","String"),
                //new Tag(48,"SecurityID","d","BIST RD","Q","String"),
                //new Tag(22,"SecurityIDSource","d","BIST RD","Q","String"),
                //new Tag(167,"SecurityType","d","BIST RD","N","String"),
                //new Tag(541,"MaturityDate","d","BIST RD","N","LocalMktDate"),
                //new Tag(20041,"NoCouponBlock","d","BIST RD","N","NumInGroup"),
                //new Tag(306,"UnderlyingIssuer","d","BIST RD","N","String"),
                //new Tag(231,"ContractMultiplier","d","BIST RD","N","float"),
                //new Tag(1244,"FlexibleIndicator","d","BIST RD","N","Boolean"),
                //new Tag(1242,"FlexProductEligibilityIndictor","d","BIST RD","N","???"),
                //new Tag(711,"NoUnderlyings","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(311,"UnderlyingSymbol","d","BIST RD","N","String"),
                //    new Tag(309,"UnderlyingSecurityID","d","BIST RD","N","String"),
                //    new Tag(305,"UnderlyingSecurityIDSource","d","BIST RD","N","String"),
                //    new Tag(318,"UnderlyingCurrency","d","BIST RD","N","Currency"),}),
                //new Tag(21019,"NoCollUnderlyings","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(21020,"CollUnderlyingSymbol","d","BIST RD","N","String"),
                //    new Tag(21021,"CollUnderlyingSecurityID","d","BIST RD","N","String"),
                //    new Tag(21022,"CollUnderlyingSecurityIDSource","d","BIST RD","N","String"),
                //    new Tag(21023,"CollUnderlyingCurrency","d","BIST RD","N","String"),}),
                //new Tag(200,"MaturityMonthYear","d","BIST RD","N","MonthYear"),
                //new Tag(201,"PutOrCall","d","BIST RD","N","int"),
                //new Tag(202,"StrikePrice","d","BIST RD","N","Price"),
                //new Tag(15,"Currency","d","BIST RD","N","Currency"),
                //new Tag(21001,"InstClassification","d","BIST RD","N","String"),
                //new Tag(20035,"LastTradingDate","d","BIST RD","N","String"),
                //new Tag(20037,"FirstTradingDate","d","BIST RD","N","String"),
                //new Tag(20036,"LastTradingTime","d","BIST RD","N","String"),
                //new Tag(20038,"FirstTradingTime","d","BIST RD","N","String"),
                //new Tag(20039,"SectorCode","d","BIST RD","N","String"),
                //new Tag(20040,"SectorCodeDesc","d","BIST RD","N","String"),
                //new Tag(225,"IssueDate","d","BIST RD","N","LocalMktDate"),
                //new Tag(873,"DatedDate","d","BIST RD","N","LocalMktDate"),
                //new Tag(454,"NoSecurityAltID","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(455,"SecurityAltID","d","BIST RD","N","String"),}),
                //new Tag(456,"SecurityAltIDSource","d","BIST RD","N","String"),
                //new Tag(555,"NoLegs","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(600,"LegSymbol","d","BIST RD","N","String"),
                //    new Tag(602,"LegSecurityID","d","BIST RD","N","String"),
                //    new Tag(603,"LegSecurityIDSource","d","BIST RD","N","String"),
                //    new Tag(623,"LegRatioQty","d","BIST RD","N","float"),
                //    new Tag(624,"LegSide","d","BIST RD","N","char"),}),
                //new Tag(1310,"NoMarketSegments","d","BIST RD","Q","NumInGroup",new List<Tag>(){
                //    new Tag(1301,"MarketID","d","BIST RD","Q","Exchange"),
                //    new Tag(1300,"MarketSegmentID","d","BIST RD","N","String"),
                //    new Tag(1396,"MarketSegmentDesc","d","BIST RD","N","String"),
                //    new Tag(1205,"NoTickRules","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(1206,"StartTickPriceRange","d","BIST RD","N","Price"),
                //        new Tag(1207,"EndTickPriceRange","d","BIST RD","N","Price"),
                //        new Tag(1208,"TickIncrement","d","BIST RD","N","Price"),}),
                //    new Tag(21015,"NoCollTickRules","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(21016,"CollTickIncrement","d","BIST RD","N","Price"),
                //        new Tag(21017,"CollStartTickPriceRange","d","BIST RD","N","Price"),
                //        new Tag(21018,"CollEndTickPriceRange","d","BIST RD","N","Price"),}),
                //    new Tag(1234,"NoLotTypeRules","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(1093,"LotType","d","BIST RD","N","char"),
                //        new Tag(1231,"MinLotSize","d","BIST RD","N","long"),
                //        new Tag(21010,"LotStartPrice","d","BIST RD","N","Price"),
                //        new Tag(21012,"LotMaxTradeVol","d","BIST RD","N","long"),
                //        new Tag(21013,"LotMinQty","d","BIST RD","N","long"),
                //        new Tag(21009,"LotDisplayHighQty","d","BIST RD","N","long"),
                //        new Tag(21014,"LotDisplayLowQty","d","BIST RD","N","long"),
                //        new Tag(21011,"LotDefaultQtyLimit","d","BIST RD","N","Boolean"),}),}),
                //new Tag(228,"Factor","d","BIST RD","N","float"),
                //new Tag(292,"CorporateAction","d","BIST RD","N","MultipleCharValue"),
                //new Tag(1150,"TradingReferencePrice","d","BIST RD","N","Price"),
                //new Tag(21003,"BasePrice","d","BIST RD","N","Price"),
                //new Tag(1116,"NoRootPartyIDs","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(1117,"RootPartyID","d","BIST RD","Q","String"),
                //    new Tag(1118,"RootPartyIDSource","d","BIST RD","Q","char"),
                //    new Tag(1119,"RootPartyRole","d","BIST RD","Q","int"),
                //    new Tag(1120,"NoRootPartySubIDs","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(1121,"RootPartySubID","d","BIST RD","N","String"),
                //        new Tag(1122,"RootPartySubIDType","d","BIST RD","N","int"),}),}),
                //new Tag(21004,"TradingMethod","d","BIST RD","N","String"),
                //new Tag(21005,"GrossSettlement","d","BIST RD","N","Boolean"),
                //new Tag(916,"StartDate","d","BIST RD","N","LocalMktDate"),
                //new Tag(917,"EndDate","d","BIST RD","N","LocalMktDate"),
                //new Tag(577,"ClearingInstruction","d","BIST RD","N","int"),
                //new Tag(325,"Unsolicited","d","BIST RD","N","???"),
                //new Tag(21007,"TradingSessionName","d","BIST RD","N","String"),
                //new Tag(21008,"PartitionId","d","BIST RD","Q","String"),
                //new Tag(21026,"DerivativeLevel","d","BIST RD","N","int"),
                //new Tag(21027,"NumberOfSharesIssued","d","BIST RD","N","long"),
                //new Tag(21028,"PhysicalDelivery","d","BIST RD","N","Boolean"),
                //new Tag(21029,"Multiplier","d","BIST RD","N","String"),
                //new Tag(21030,"Reference","d","BIST RD","N","String"),
                //new Tag(21032,"InstrumentType","d","BIST RD","Q","String"),
                //new Tag(21031,"SeriesDesc","d","BIST RD","Q","String"),
                //new Tag(1194,"ExerciseStyle","d","BIST RD","N","int"),
                //new Tag(965,"SecurityStatus","d","BIST RD","Q","String"),
                //new Tag(1148,"LowLimitPrice","d","BIST RD","N","Price"),
                //new Tag(1149,"HighLimitPrice","d","BIST RD","N","Price"),
                //new Tag(5011,"OrderMaxValue","d","BIST RD","N","Qty"),
                //new Tag(38,"OrderQty","d","BIST RD","N","Qty"),
                //new Tag(159,"AccuredInterestAmt","d","BIST RD","N","???"),
                //new Tag(1948,"CouponFrequencyPeriod","d","BIST RD","N","float"),
                //new Tag(1949,"CouponFrequencyUnit","d","BIST RD","N","String"),
                //new Tag(1950,"CouponDayCount","d","BIST RD","N","int"),
                //new Tag(21059,"CouponInterest","d","BIST RD","N","float"),
                //new Tag(21055,"OddFirstCoupon","d","BIST RD","N","Boolean"),
                //new Tag(21056,"OddLastCoupon","d","BIST RD","N","Boolean"),
                //new Tag(21057,"PremiumUnit","d","BIST RD","N","int"),
                //new Tag(21058,"FixedIncomeType","d","BIST RD","N","int"),
                //new Tag(1940,"AssetType","d","BIST RD","N","String"),
                //new Tag(1938,"AssetClass","d","BIST RD","N","int"),
                //new Tag(1939,"AssetSubClass","d","BIST RD","N","int"),
                //new Tag(996,"UnitOfMeasure","d","BIST RD","N","String"),
                //new Tag(21061,"FinenessNotation","d","BIST RD","N","int"),
                //new Tag(21062,"MetalWeightConversionFactor","d","BIST RD","N","Qty"),
                //new Tag(21060,"Fineness","d","BIST RD","N","Qty"),
                //new Tag(1147,"UnitOfMeasureQty","d","BIST RD","N","Qty"),
                //new Tag(21050,"NoTradeReports","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(21051,"TradeReportCode","d","BIST RD","N","int"),
                //    new Tag(21052,"MinTradeRepQty","d","BIST RD","N","Qty"),
                //    new Tag(21053,"MaxTradeRepQty","d","BIST RD","N","Qty"),
                //    new Tag(21064,"TrLotsize","d","BIST RD","N","???"),}),
                //new Tag(60,"TransactTime","d","BIST RD","N","UTCTimestamp"),
                //new Tag(2304,"NoAssetAttributes","d","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(2305,"AssetAttributeType","d","BIST RD","N","String"),
                //    new Tag(2306,"AssetAttributeValue","d","BIST RD","N","String"),}),
                //new Tag(21063,"DaysToMaturity","d","BIST RD","/","???"),
                //new Tag(8000,"ShortSaleRestriction","d","BIST RD","N","???"),
                //new Tag(320,"SecurityReqID","c","BIST RD","Y","String"),
                //new Tag(321,"SecurityRequestType","c","BIST RD","Y","int"),
                //new Tag(55,"Symbol","c","BIST RD","Q","String"),
                //new Tag(1180,"ApplicationSequenceControl/ApplID","BP","BIST RD","Q","???"),
                //new Tag(1181,"ApplicationSequenceControl/ApplSeqNum","BP","BIST RD","Q","???"),
                //new Tag(1350,"ApplicationSequenceControl/ApplLastSeqNum","BP","BIST RD","Q","???"),
                //new Tag(980,"SecurityUpdateAction","BP","BIST RD","Q","char"),
                //new Tag(55,"Symbol","BP","BIST RD","Q","String"),
                //new Tag(107,"SecurityDesc","BP","BIST RD","N","String"),
                //new Tag(48,"SecurityID","BP","BIST RD","Q","String"),
                //new Tag(22,"SecurityIDSource","BP","BIST RD","Q","String"),
                //new Tag(167,"SecurityType","BP","BIST RD","N","String"),
                //new Tag(541,"MaturityDate","BP","BIST RD","N","LocalMktDate"),
                //new Tag(20041,"NoCouponBlock","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(223,"CouponRate","BP","BIST RD","N","Percentage"),
                //    new Tag(224,"CouponPaymentDate","BP","BIST RD","N","LocalMktDate"),}),
                //new Tag(306,"UnderlyingIssuer","BP","BIST RD","N","String"),
                //new Tag(231,"ContractMultiplier","BP","BIST RD","N","float"),
                //new Tag(1244,"FlexibleIndicator","BP","BIST RD","N","Boolean"),
                //new Tag(1242,"FlexProductEligibilityIndictor","BP","BIST RD","N","???"),
                //new Tag(711,"NoUnderlyings","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(311,"UnderlyingSymbol","BP","BIST RD","N","String"),
                //    new Tag(318,"UnderlyingCurrency","BP","BIST RD","N","Currency"),
                //    new Tag(309,"UnderlyingSecurityID","BP","BIST RD","N","String"),
                //    new Tag(305,"UnderlyingSecurityIDSource","BP","BIST RD","N","String"),}),
                //new Tag(21019,"NoCollUnderlyings","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(21020,"CollUnderlyingSymbol","BP","BIST RD","N","String"),
                //    new Tag(21021,"CollUnderlyingSecurityID","BP","BIST RD","N","String"),
                //    new Tag(21022,"CollUnderlyingSecurityIDSource","BP","BIST RD","N","String"),
                //    new Tag(21023,"CollUnderlyingCurrency","BP","BIST RD","N","String"),}),
                //new Tag(200,"MaturityMonthYear","BP","BIST RD","N","MonthYear"),
                //new Tag(201,"PutOrCall","BP","BIST RD","N","int"),
                //new Tag(202,"StrikePrice","BP","BIST RD","N","Price"),
                //new Tag(15,"Currency","BP","BIST RD","N","Currency"),
                //new Tag(21001,"InstClassification","BP","BIST RD","N","String"),
                //new Tag(20035,"LastTradingDate","BP","BIST RD","N","String"),
                //new Tag(20036,"LastTradingTime","BP","BIST RD","N","String"),
                //new Tag(20037,"FirstTradingDate","BP","BIST RD","N","String"),
                //new Tag(20038,"FirstTradingTime","BP","BIST RD","N","String"),
                //new Tag(20039,"SectorCode","BP","BIST RD","N","String"),
                //new Tag(20040,"SectorCodeDesc","BP","BIST RD","N","String"),
                //new Tag(225,"IssueDate","BP","BIST RD","N","LocalMktDate"),
                //new Tag(873,"DatedDate","BP","BIST RD","N","LocalMktDate"),
                //new Tag(454,"NoSecurityAltID","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(455,"SecurityAltID","BP","BIST RD","N","String"),
                //    new Tag(456,"SecurityAltIDSource","BP","BIST RD","N","String"),}),
                //new Tag(555,"NoLegs","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(600,"LegSymbol","BP","BIST RD","N","String"),
                //    new Tag(602,"LegSecurityID","BP","BIST RD","N","String"),
                //    new Tag(603,"LegSecurityIDSource","BP","BIST RD","N","String"),
                //    new Tag(623,"LegRatioQty","BP","BIST RD","N","float"),
                //    new Tag(624,"LegSide","BP","BIST RD","N","char"),}),
                //new Tag(1310,"NoMarketSegments","BP","BIST RD","Q","NumInGroup",new List<Tag>(){
                //    new Tag(1301,"MarketID","BP","BIST RD","Q","Exchange"),
                //    new Tag(1300,"MarketSegmentID","BP","BIST RD","N","String"),
                //    new Tag(1396,"MarketSegmentDesc","BP","BIST RD","N","String"),
                //    new Tag(1205,"NoTickRules","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(1206,"StartTickPriceRange","BP","BIST RD","N","Price"),
                //        new Tag(1207,"EndTickPriceRange","BP","BIST RD","N","Price"),
                //        new Tag(1208,"TickIncrement","BP","BIST RD","N","Price"),}),
                //    new Tag(21015,"NoCollTickRules","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(21016,"CollTickIncrement","BP","BIST RD","N","Price"),
                //        new Tag(21017,"CollStartTickPriceRange","BP","BIST RD","N","Price"),
                //        new Tag(21018,"CollEndTickPriceRange","BP","BIST RD","N","Price"),
                //        new Tag(1234,"NoLotTypeRules","BP","BIST RD","N","NumInGroup"),
                //        new Tag(1093,"LotType","BP","BIST RD","N","char"),
                //        new Tag(1231,"MinLotSize","BP","BIST RD","N","long"),
                //        new Tag(21010,"LotStartPrice","BP","BIST RD","N","Price"),
                //        new Tag(21012,"LotMaxTradeVol","BP","BIST RD","N","long"),
                //        new Tag(21013,"LotMinQty","BP","BIST RD","N","long"),
                //        new Tag(21009,"LotDisplayHighQty","BP","BIST RD","N","long"),
                //        new Tag(21014,"LotDisplayLowQty","BP","BIST RD","N","long"),
                //        new Tag(21011,"LotDefaultQtyLimit","BP","BIST RD","N","Boolean"),}),}),
                //new Tag(228,"Factor","BP","BIST RD","N","float"),
                //new Tag(292,"CorporateAction","BP","BIST RD","N","MultipleCharValue"),
                //new Tag(1150,"TradingReferencePrice","BP","BIST RD","N","Price"),
                //new Tag(21003,"BasePrice","BP","BIST RD","N","Price"),
                //new Tag(1116,"NoRootPartyIDs","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(1117,"RootPartyID","BP","BIST RD","Q","String"),
                //    new Tag(1118,"RootPartyIDSource","BP","BIST RD","Q","char"),
                //    new Tag(1119,"RootPartyRole","BP","BIST RD","Q","int"),
                //    new Tag(1120,"NoRootPartySubIDs","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(1121,"RootPartySubID","BP","BIST RD","N","String"),
                //        new Tag(1122,"RootPartySubIDType","BP","BIST RD","N","int"),}),}),
                //new Tag(21004,"TradingMethod","BP","BIST RD","N","String"),
                //new Tag(21005,"GrossSettlement","BP","BIST RD","N","Boolean"),
                //new Tag(916,"StartDate","BP","BIST RD","N","LocalMktDate"),
                //new Tag(917,"EndDate","BP","BIST RD","N","LocalMktDate"),
                //new Tag(577,"ClearingInstruction","BP","BIST RD","N","int"),
                //new Tag(21007,"TradingSessionName","BP","BIST RD","N","String"),
                //new Tag(21008,"PartitionId","BP","BIST RD","N","String"),
                //new Tag(21026,"DerivativeLevel","BP","BIST RD","N","int"),
                //new Tag(21027,"NumberOfSharesIssued","BP","BIST RD","N","long"),
                //new Tag(21028,"PhysicalDelivery","BP","BIST RD","N","Boolean"),
                //new Tag(21029,"Multiplier","BP","BIST RD","N","String"),
                //new Tag(21030,"Reference","BP","BIST RD","N","String"),
                //new Tag(21032,"InstrumentType","BP","BIST RD","Q","String"),
                //new Tag(21031,"SeriesDesc","BP","BIST RD","Q","String"),
                //new Tag(1194,"ExerciseStyle","BP","BIST RD","N","int"),
                //new Tag(965,"SecurityStatus","BP","BIST RD","Q","String"),
                //new Tag(1148,"LowLimitPrice","BP","BIST RD","N","Price"),
                //new Tag(1149,"HighLimitPrice","BP","BIST RD","N","Price"),
                //new Tag(5011,"OrderMaxValue","BP","BIST RD","N","Qty"),
                //new Tag(38,"OrderQty","BP","BIST RD","N","Qty"),
                //new Tag(159,"AccuredInterestAmt","BP","BIST RD","N","???"),
                //new Tag(1948,"CouponFrequencyPeriod","BP","BIST RD","N","float"),
                //new Tag(1949,"CouponFrequencyUnit","BP","BIST RD","N","String"),
                //new Tag(1950,"CouponDayCount","BP","BIST RD","N","int"),
                //new Tag(21059,"CouponInterest","BP","BIST RD","N","float"),
                //new Tag(21055,"OddFirstCoupon","BP","BIST RD","N","Boolean"),
                //new Tag(21056,"OddLastCoupon","BP","BIST RD","N","Boolean"),
                //new Tag(21057,"PremiumUnit","BP","BIST RD","N","int"),
                //new Tag(21058,"FixedIncomeType","BP","BIST RD","N","int"),
                //new Tag(1940,"AssetType","BP","BIST RD","N","String"),
                //new Tag(1938,"AssetClass","BP","BIST RD","N","int"),
                //new Tag(1939,"AssetSubClass","BP","BIST RD","N","int"),
                //new Tag(996,"UnitOfMeasure","BP","BIST RD","N","String"),
                //new Tag(21061,"FinenessNotation","BP","BIST RD","N","int"),
                //new Tag(21062,"MetalWeightConversionFactor","BP","BIST RD","N","Qty"),
                //new Tag(21060,"Fineness","BP","BIST RD","N","Qty"),
                //new Tag(4,"decimal","BP","BIST RD","N","???"),
                //new Tag(1147,"UnitOfMeasureQty","BP","BIST RD","N","Qty"),
                //new Tag(21050,"NoTradeReports","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(21051,"TradeReportCode","BP","BIST RD","N","int"),
                //    new Tag(21052,"MinTradeRepQty","BP","BIST RD","N","Qty"),
                //    new Tag(21053,"MaxTradeRepQty","BP","BIST RD","N","Qty"),
                //    new Tag(21064,"TrLotsize","BP","BIST RD","N","???"),}),
                //new Tag(60,"TransactTime","BP","BIST RD","N","UTCTimestamp"),
                //new Tag(2304,"NoAssetAttributes","BP","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(2305,"AssetAttributeType","BP","BIST RD","N","String"),
                //    new Tag(2306,"AssetAttributeValue","BP","BIST RD","N","String"),}),
                //new Tag(21063,"DaysToMaturity","BP","BIST RD","/","???"),
                //new Tag(8000,"ShortSaleRestriction","BP","BIST RD","N","???"),
                //new Tag(1180,"ApplicationSequenceControl/ApplID","BU","BIST RD","Q","???"),
                //new Tag(1181,"ApplicationSequenceControl/ApplSeqNum","BU","BIST RD","Q","???"),
                //new Tag(1350,"ApplicationSequenceControl/ApplLastSeqNum","BU","BIST RD","Q","???"),
                //new Tag(1394,"MarketReportID","BU","BIST RD","Y","String"),
                //new Tag(1301,"MarketID","BU","BIST RD","Y","Exchange"),
                //new Tag(1180,"ApplicationSequenceControl/ApplID","BJ","BIST RD","Q","???"),
                //new Tag(1181,"ApplicationSequenceControl/ApplSeqNum","BJ","BIST RD","Q","???"),
                //new Tag(1350,"ApplicationSequenceControl/ApplLastSeqNum","BJ","BIST RD","Q","???"),
                //new Tag(386,"NoTradingSessions","BJ","BIST RD","Y","NumInGroup",new List<Tag>(){
                //    new Tag(336,"TradingSessionID","BJ","BIST RD","Y","String"),
                //    new Tag(1326,"TradingSessionDesc","BJ","BIST RD","Q","String"),
                //    new Tag(1237,"NoOrdTypeRules","BJ","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(40,"OrdType","BJ","BIST RD","N","char"),}),
                //    new Tag(1239,"NoTimeInForceRules","BJ","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(59,"TimeInForce","BJ","BIST RD","N","char"),}),
                //    new Tag(1235,"NoMatchRules","BJ","BIST RD","N","NumInGroup",new List<Tag>(){
                //        new Tag(1142,"MatchAlgorithm","BJ","BIST RD","N","String"),
                //        new Tag(574,"MatchType","BJ","BIST RD","N","String"),}),
                //    new Tag(20032,"SessionStateTypeNumber","BJ","BIST RD","N","int"),
                //    new Tag(21024,"OffHoursTrading","BJ","BIST RD","N","Boolean"),}),
                //new Tag(263,"Subscription","e","BIST RD","N","???"),
                //new Tag(55,"Symbol","e","BIST RD","Q","String"),
                //new Tag(324,"SecurityStatusReqID","e","BIST RD","Q","String"),
                //new Tag(1180,"ApplicationSequenceControl/ApplID","f","BIST RD","Q","???"),
                //new Tag(1181,"ApplicationSequenceControl/ApplSeqNum","f","BIST RD","Q","???"),
                //new Tag(1350,"ApplicationSequenceControl/ApplLastSeqNum","f","BIST RD","Q","???"),
                //new Tag(55,"Symbol","f","BIST RD","Q","String"),
                //new Tag(48,"SecurityID","f","BIST RD","Q","String"),
                //new Tag(22,"SecurityIDSource","f","BIST RD","Q","String"),
                //new Tag(336,"TradingSessionID","f","BIST RD","N","String"),
                //new Tag(326,"SecurityTradingStatus","f","BIST RD","N","int"),
                //new Tag(325,"Unsolicited","f","BIST RD","N","???"),
                //new Tag(292,"CorporateAction","f","BIST RD","N","MultipleCharValue"),
                //new Tag(31,"LastPx","f","BIST RD","N","Price"),
                //new Tag(55,"Symbol","pp","BIST RD","Q","String"),
                //new Tag(1180,"ApplicationSequenceControl/ApplID","pr","BIST RD","Q","???"),
                //new Tag(1181,"ApplicationSequenceControl/ApplSeqNum","pr","BIST RD","Q","???"),
                //new Tag(1350,"ApplicationSequenceControl/ApplLastSeqNum","pr","BIST RD","Q","???"),
                //new Tag(55,"Symbol","pr","BIST RD","Q","String"),
                //new Tag(48,"SecurityID","pr","BIST RD","Q","String"),
                //new Tag(22,"SecurityIDSource","pr","BIST RD","Q","String"),
                //new Tag(325,"Unsolicited","pr","BIST RD","N","???"),
                //new Tag(1148,"LowLimitPrice","pr","BIST RD","N","Price"),
                //new Tag(1149,"HighLimitPrice","pr","BIST RD","N","Price"),
                //new Tag(1150,"TradingReferencePrice","pr","BIST RD","N","Price"),
                //new Tag(21003,"Base","pr","BIST RD","N","???"),
                //new Tag(21025,"TheoreticalPrice","pr","BIST RD","N","Price"),
                //new Tag(140,"PrevClosePx","pr","BIST RD","N","Price"),
                //new Tag(60,"TransactTime","pr","BIST RD","N","UTCTimestamp"),
                //new Tag(1180,"ApplicationSequenceControl/ApplID","mm","BIST RD","Q","???"),
                //new Tag(1181,"ApplicationSequenceControl/ApplSeqNum","mm","BIST RD","Q","???"),
                //new Tag(1350,"ApplicationSequenceControl/ApplLastSeqNum","mm","BIST RD","Q","???"),
                //new Tag(55,"Symbol","mm","BIST RD","Q","String"),
                //new Tag(48,"SecurityID","mm","BIST RD","Q","String"),
                //new Tag(22,"SecurityIDSource","mm","BIST RD","Q","String"),
                //new Tag(202,"Strike","mm","BIST RD","N","???"),
                //new Tag(541,"MaturityDate","mm","BIST RD","Q","LocalMktDate"),
                //new Tag(21054,"ATMPrice","mm","BIST RD","Q","???"),
                //new Tag(21003,"BasePrice","mm","BIST RD","Q","Price"),
                //new Tag(201,"PutOrCall","mm","BIST RD","Q","int"),
                //new Tag(60,"TransactTime","mm","BIST RD","N","UTCTimestamp"),
                //new Tag(1346,"ApplReqID","BW","BIST RD","Y","String"),
                //new Tag(1347,"ApplReqType","BW","BIST RD","Y","int"),
                //new Tag(1351,"NoApplIDs","BW","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(1355,"RefApplID","BW","BIST RD","Q","String"),
                //    new Tag(1182,"ApplBegSeqNum","BW","BIST RD","N","SeqNum"),
                //    new Tag(1183,"ApplEndSeqNum","BW","BIST RD","N","SeqNum"),}),
                //new Tag(1353,"ApplResponseID","BX","BIST RD","Y","String"),
                //new Tag(1346,"ApplReqID","BX","BIST RD","Q","String"),
                //new Tag(1347,"ApplReqType","BX","BIST RD","Q","int"),
                //new Tag(1348,"ApplResponseType","BX","BIST RD","Q","int"),
                //new Tag(1351,"NoApplIDs","BX","BIST RD","N","NumInGroup",new List<Tag>(){
                //    new Tag(1355,"RefApplID","BX","BIST RD","N","String"),
                //    new Tag(1182,"ApplBegSeqNum","BX","BIST RD","N","SeqNum"),
                //    new Tag(1183,"ApplEndSeqNum","BX","BIST RD","N","SeqNum"),
                //    new Tag(1354,"ApplResponseError","BX","BIST RD","N","int"),}),
                //new Tag(58,"Text","BX","BIST RD","N","String"),
                //new Tag(1128,"ApplVerID","BX","BIST RD","N","String"),
